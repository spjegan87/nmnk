...
<form action='../sql_query/services_updates_delete.php' method='post'>
	<div class='dashboard-container'>
		...
		<h4 class="header-title">Social Service Project Details <a href="index.php?page=web-social-service.php" class='pull-right icons'><i class="fa fa-plus-square-o" aria-hidden="true"></i>Add New Service Posts</a></h4>
		<div class='row'>
			<div class='col-sm-12'>
				<div class='panel-type-bg'>
					...
					<p class="error-txt"><?php if(isset($_GET['msg']) and $_GET['msg'] == 'servicesdelete') echo "1 Record deleted successfully."; ?></p>
