			...
			<div class='row'>
				<div class='col-sm-3'>
					<div class="form-group">
						...
						<label class='calendar'><input type="text" class="form-control number" name="dateofjoin" id="date1" placeholder="Select date of joining" value='<?php echo $rows['doj']; ?>' required /></label>
					</div>
				</div>
				<div class='col-sm-3'>
					<div class="form-group">
						<label for="activeplace" class='mandatory'>Active Place</label>
						<input type="text" class="form-control" id="activeplace" name="activeplace" placeholder="Enter person active place" value='<?php echo $rows['actplace']; ?>' required />
					</div>
				</div>
				<div class='col-sm-3'>
					<div class="form-group">
				...
				<div class='col-sm-6'>
					<div class="form-group">
						...
						<textarea id="reason" name="reason" rows="4" cols="" class="form-control"placeholder="Write your joining reason"><?php echo $rows['reason']; ?></textarea>
					</div>
				</div>
