			...
			<div class='row'>
				...
				<div class='clone'>
					...
					<div class='col-sm-4 col-xs-10'>
						<div class="form-group">
							<label for="gallerytext" class='textindex gallerytext'><h5></h5></label><br />
							<input type="text" name='gallerytext' autocomplete="off" value="" class="form-control gallertext"/ >
						</div>
					</div>
					<div class="col-sm-3 padd-none col-xs-2">
