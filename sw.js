...
var cacheFilesLocal = [
			'/wecandoit/common/index.php',
			'/wecandoit/css/custom-style.css',
			'/wecandoit/css/admin-style.css',
			'/wecandoit/contactus.php',
			'/wecandoit/css/bootstrap.min.css',
			'/wecandoit/js/bootstrap.js'
